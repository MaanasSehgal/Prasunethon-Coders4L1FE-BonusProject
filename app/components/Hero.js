...
const GridLayout = () => {
    return (
        <div className="pt-32 relative overflow-hidden bg-white">
            <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48 flex justify-center items-center md:block sm:mx-auto">
                <div className="relative px-4 sm:static sm:px-6 lg:px-12">
                    <div className="w-2/3 mx-auto lg:max-w-lg lg:mx-0">
                        ...
                        <a href="#" className="inline-block rounded-md border border-transparent bg-indigo-600 py-3 mt-8 px-8 text-center font-medium text-white hover:bg-indigo-700">
                            Join Us Now
                        </a>
                    </div>
                    <div className="mt-10 pt-40">
                        <div aria-hidden="true" className="pointer-events-none lg:absolute lg:inset-y-0 lg:w-full lg:max-w-7xl lg:mx-60">

                    ...
                    <div className="lg:mx-auto text-left">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6 cursor-pointer">
                                <div className="text-[--darkText2] hover:text-[--darkText1]">FAQs</div>
                            </li>
                            <li className="mb-6 cursor-pointer">
                                <div className=" text-[--darkText2] hover:text-[--darkText1]">Quick Start</div>
                            </li>
                            <li className="mb-6 cursor-pointer">
                                <div className=" text-[--darkText2] hover:text-[--darkText1]">Documentation</div>
                            </li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6 cursor-pointer">
                                <div className=" text-[--darkText2] hover:text-[--darkText1]">Tips & Tricks</div>
                            </li>
                            <li className="mb-6 cursor-pointer">
                                <div className=" text-[--darkText2] hover:text-[--darkText1]">Latest Updates</div>
                            </li>
                            <li className="cursor-pointer">
                                <div className=" text-[--darkText2] hover:text-[--darkText1]">Events</div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <Link href="https://www.linkedin.com/in/maanassehgal" className="text-sm text-[darkText1] underline underline-offset-4">
                            <div>@Smart City 2024, All rights reserved.</div>
                        </Link>
                        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <Link href="https://www.linkedin.com/in/maanassehgal/" target="_blank" className="w-9 h-9 rounded-full flex justify-center items-center hover:bg-gray-200">
                            ...
                            <Link href="https://www.instagram.com/maanas1605" target="_blank" className="w-9 h-9 rounded-full flex justify-center items-center hover:bg-gray-200">
                                <svg className="w-[1.25rem] h-[1.125rem] text-[darkText1]" viewBox="0 0 15 15" fill="none" xmlns="">
                                    <path
                            ...
                            <Link target="_blank" href="https://www.youtube.com/channel/UClkCw-5GSwAxVIDgYUDqR3A" className="w-9 h-9 rounded-full flex justify-center items-center hover:bg-gray-200">
                                <svg className="w-[1.25rem] h-[0.875rem] text-[darkText1]" viewBox="0 0 16 12" fill="none" xmlns="">
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
